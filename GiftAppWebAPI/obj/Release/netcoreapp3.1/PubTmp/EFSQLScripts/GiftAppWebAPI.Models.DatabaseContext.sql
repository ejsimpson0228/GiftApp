...
BEGIN
    ...
    VALUES (N'20190427141139_InitialCreate', N'3.1.2');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190722180726_addedGifts', N'3.1.2');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190727130608_added-friends', N'3.1.2');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20191204124312_added_logs', N'3.1.2');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20191204125758_removed_exception', N'3.1.2');
END;
